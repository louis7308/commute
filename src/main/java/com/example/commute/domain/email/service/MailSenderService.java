...
import com.example.commute.domain.email.exception.AuthCodeExpiredException;
import com.example.commute.domain.email.exception.ManyRequestEmailAuthException;
...
public class MailSenderService {
    ...
    private void sendAuthEmail(String email, String authKey) {
        String subject = "마이다스 IT 출퇴근 서비스 인증번호";
